...
Future signup_func(String username, email, password) async {
  ...
  try{
    ...
    Response response = await dio.post('https://stack-study.me:3001/register', data: {'username': username, 'email': email, 'password': password});
    return response.data;
  }catch(e){
    print("Error in signup_func: " + e.toString());
    return null;
  }
}